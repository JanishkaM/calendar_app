...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      data-public-holiday={modifiers.publicHoliday || undefined}
      data-bank-holiday={modifiers.bankHoliday || undefined}
      data-mercantile-holiday={modifiers.mercantileHoliday || undefined}
      className={cn(
